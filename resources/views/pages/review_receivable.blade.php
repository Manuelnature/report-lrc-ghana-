...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <!-- start page title -->
        <div class="row">
            <center><h4>Receivable Review</h4></center>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="user_dataTable" class="table table-centered dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    @foreach($all_created_receivables as $all_receivables)
                                    <tr>
                                        ...
                                        <td class="payable_action_td">
                                            <form method="POST" action="{{ route('created_receivable_approve',$all_receivables->id) }}">
                                                @csrf
                                            ...
                                            <form method="POST" action="{{ route('created_receivable_reject',$all_receivables->id) }}">
                                                @csrf
